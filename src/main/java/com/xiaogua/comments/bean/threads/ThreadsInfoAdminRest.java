 ...
 */
public class ThreadsInfoAdminRest {
    /**
     * 帖子编号
     */
    private String code;
     ...
     * 帖子回复
     */
    private ThreadsReplyAdminPageRest replyPageRest;
    ...
    public ThreadsReplyAdminPageRest getReplyPageRest() {
        return replyPageRest;
    }

    public void setReplyPageRest(ThreadsReplyAdminPageRest replyPageRest) {
        this.replyPageRest = replyPageRest;
    }

    public ThreadsInfoAdminRest() {
        super();
    }

    public ThreadsInfoAdminRest(ThreadsInfoWithBLOBs threadsInfo) {
        super();
