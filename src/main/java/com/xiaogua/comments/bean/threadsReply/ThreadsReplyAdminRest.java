 ...
 */
public class ThreadsReplyAdminRest {
    /**
     * 帖子回复编号
     */
    private String code;
     ...
     * 帖子回复评论分页信息
     */
    private ThreadsReplyCommentAdminPageRest replyCommentPageRest;
    ...
    public ThreadsReplyCommentAdminPageRest getReplyCommentPageRest() {
        return replyCommentPageRest;
    }

    public void setReplyCommentPageRest(ThreadsReplyCommentAdminPageRest replyCommentPageRest) {
        this.replyCommentPageRest = replyCommentPageRest;
    }

    public ThreadsReplyAdminRest() {
        super();
    }

    public ThreadsReplyAdminRest(ThreadsReply reply) {
        super();
